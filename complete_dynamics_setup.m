...
function main()  
    ...
    %global wayReach iWay
        ...
        [y(1:4),y(5:7)] = CompleteDynNoLin_Out(x,Vw,gm);
        [uct,uout,dxdt_c] = LongControlOut(t,x,y_way,addt,bounds,AC,y);   % Longitudinal Control
        [] = LatDirControlOut(t,x,y,y_way,AC);                            % Latero-Directional COntrol
